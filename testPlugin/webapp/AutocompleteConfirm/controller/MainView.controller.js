sap.ui.define([
    ...
    return PluginViewController.extend("altea.dmc.plugin.autocompleteConfirmPlugin.controller.MainView", {
        formatter: formatter,
        ...
        */
        ...
        onShowPostings: function () {
            ...
            if (!this._oPostingsDialog) {
                Fragment.load({
                    name: "altea.dmc.plugin.autocompleteConfirmPlugin.view.fragments.PostingHistoryDialog",
                    controller: this
        ...
        onPostItem: function (oEvent) {
            ...
            if (!this._oGoodsReceiptDialog) {
                Fragment.load({
                    name: "altea.dmc.plugin.autocompleteConfirmPlugin.view.fragments.GoodsReceiptDialog",
                    controller: this
                }).then(oDialog => {
        ...
        onChiusuraManuale: async function (oEvent) {
            ...
            if (!oController.oManualClosingConfirmDialog) {
                Fragment.load({
                    ...
                    name: "altea.dmc.plugin.autocompleteConfirmPlugin.view.fragments.ManualClosingConfirmDialog",
                    controller: this
                }).then(function (oDialog) {
