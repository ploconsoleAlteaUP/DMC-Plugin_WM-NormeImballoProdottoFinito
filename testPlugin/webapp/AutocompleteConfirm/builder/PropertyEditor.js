sap.ui.define([
    ...
    return PropertyEditor.extend( "altea.dmc.plugin.autocompleteConfirmPlugin.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("altea.dmc.plugin.autocompleteConfirmPlugin.i18n.builder");
			this.setPluginResourceBundleName("altea.dmc.plugin.autocompleteConfirmPlugin.i18n.i18n");
		},
