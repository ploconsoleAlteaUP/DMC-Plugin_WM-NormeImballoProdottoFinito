sap.ui.define([
    ...
    return PropertyEditor.extend( "altea.dmc.plugin.testPlugin.autocompleteConfirm.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("altea.dmc.plugin.testPlugin.autocompleteConfirm.i18n.builder");
			this.setPluginResourceBundleName("altea.dmc.plugin.testPlugin.autocompleteConfirm.i18n.i18n");
		},
